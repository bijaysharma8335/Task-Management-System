    ...
    return (
        <div className="w-full flex flex-col gap-3 mb-4 overflow-y-hidden">
            ...
            <Tabs tabs={TABS} setSelected={setSelected}>
                {selected === 0 ? (
                    <>
                        <div className="w-full flex md:flex-row gap-5 2xl:gap-8 bg-white shadow-md p-8 overflow-y-auto">
                            <div className="w-full md:w-1/2 space-y-8">
                                <div className="flex items-center gap-5">
                                    ...
                                    >
                                        <span className="lext-lg">{ICONS[task.priority]}</span>
                                        <span className="lext-lg">
                                            {ICONS[task.priority]} Priority
                                        </span>
                                    </div>
                                ...
                                <p className="text-gray-500">
                                    Created At: {new Date(task.date).toString()}
                                </p>
