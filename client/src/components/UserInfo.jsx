            ...
            <Popover className="relative">
                {({ open }) => (
                    <>
                        ...
                        >
                            <PopoverPanel className="absolute left-1/2 z-10 mt-3 w-90 max-w-sm -translate-x-1/2 transform px4 sm:px-0">
                                <div className="flex items-center gap-4 rounded-lg shadow-lg bg-white px-4">
